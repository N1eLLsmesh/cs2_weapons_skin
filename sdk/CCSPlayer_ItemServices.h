...
private:
	...
	virtual SC_CBaseEntity* _GiveNamedItem(const char* pchName, int iSubType) = 0;
public:
	virtual bool GiveNamedItemBool(const char* pchName, int iSubType) = 0;
	virtual SC_CBaseEntity* GiveNamedItem(const char* pchName, int iSubType) = 0;
